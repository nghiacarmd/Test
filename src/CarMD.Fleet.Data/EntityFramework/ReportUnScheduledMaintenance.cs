...
{
    public partial class ReportUnScheduledMaintenance
    {
        public ReportUnScheduledMaintenance()
        {
            ReportUnScheduledMaintenanceFixPart = new HashSet<ReportUnScheduledMaintenanceFixPart>();
        }
        ...
        public virtual ICollection<ReportUnScheduledMaintenanceFixPart> ReportUnScheduledMaintenanceFixPart { get; set; }

        public ReportUnScheduledMaintenance(ScheduledMaintenance source)
        {
            Name = source.Name;
            Id = Guid.NewGuid();
            ...
            if (fix != null)
            {
                ...
                {
                    ReportUnScheduledMaintenanceFixPart = fix.FixParts.Select(v => new ReportUnScheduledMaintenanceFixPart(v)).ToList();
                }
            }
